...
public class ViewAdminConfigure extends JFrame {
    ...
    private JPanel createGeneralTab() {
        ...
        combo.setSelectedIndex(-1); // không chọn gì khi mở form
    ...
    public void initUserButtonEvents(AdminController controller) {
        ...
        btnAdd.addActionListener(e -> {
            String username = JOptionPane.showInputDialog(this, "Enter new username", "Add User",
